...
# 1. Stelle sicher, dass die 'transformers' Bibliothek installiert ist.
#    Dies kann mit 'pip install transformers' erfolgen.
# 2. Führe das Skript in einer Umgebung aus, die PyTorch unterstützt
#    (z.B. Jupyter Notebook, lokal installierte Python-Umgebung).
# 3. Das Skript übersetzt englischen Text nach deutscher Sprache
#    und kann leicht angepasst werden, um andere Sprachpaare zu verwenden
#    (natürlich muss das entsprechende Modell geladen werden).
#    Eine Liste verfügbarer Modelle kann auf der Hugging Face Model Hub Website gefunden werden.
